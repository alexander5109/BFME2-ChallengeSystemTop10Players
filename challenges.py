...
class Challenge:
	...
	_score2v2 = None
	_scoreTotal = None
	_defended_or_took_over = None
	_version_or_no_score = None
	_spotUndefended = None
	#---------------------------#
